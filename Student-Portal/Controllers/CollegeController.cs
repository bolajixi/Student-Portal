...
namespace Student_Portal.Controllers
{
    public class CollegeController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,MyProperty,numDept")] College college)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,MyProperty,numDept")] College college)
        {
            if (ModelState.IsValid)
            {
